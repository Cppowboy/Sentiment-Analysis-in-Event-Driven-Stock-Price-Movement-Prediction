...
def PRICE(ticker):
    ...
    url = 'https://finance.yahoo.com/quote/{}/history?period1=1072886400&period2=1511107200&interval=1d&filter=history&frequency=1d'
    url = url.format(ticker)

    socks.setdefaultproxy(socks.PROXY_TYPE_SOCKS5, "127.0.0.1", 55844)
